...
const NavBar = () => {
    ...
    return (
        <nav>
            <div className="flex flex-col gap-x-4 items-center bg-slate-800 text-white lg:p-0 sm:rounded-lg lg:flex-row">
                ...
                <div className="text-center">
                    ...
                    <ul className={`flex flex-row items-center gap-x-1 transition-all duration-500 lg:flex-row lg:p-0
